...
public static class LitdFragment
{
    ...
    public static string Yaml =>
        $$"""
        # Generated by the BTCPay Server "Lightning Terminal" plugin. Managed by the plugin, not by hand.
        # btcpayserver-docker's {{TerminalOptions.UpstreamFragmentName}}.yml with litd's web UI off, no
        # public routes, and litd's data directory mounted into the BTCPay container so the plugin can
        # read it. Full rationale: https://github.com/lightninglabs/terminal-btcpay#readme
